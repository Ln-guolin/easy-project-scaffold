...
INSERT INTO `config_info`(name,url,branch,username,password,enable_def_variable,custom_variable) VALUES ('自定义变量', 'http://u.32e.co:8122/git/root/demo3.git','master', 'root', 'root',0,'app-name,k8s-namespace,nacos-server-addr,nacos-namespace,k8s-image-domain-path,port,k8s-image-pull-secrets,skywalking.agent.namespace');
